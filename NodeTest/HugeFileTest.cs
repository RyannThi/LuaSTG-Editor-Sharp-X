...
namespace NodeTest
{
    ...
    public class HugeFileTest
    {
        ...
        public void CreateHugeFile()
        {
            ...
            sw.WriteLine("1,{\"$type\":\"LuaSTGEditorSharp.EditorData.Node.EditorVersion, LuaSTGEditorSharp\",\"attributes\":[{\"attrCap\":\"Editor version\",\"attrInput\":\"0.78.3\",\"EditWindow\":\"\"}],\"IsExpanded\":true,\"IsSelected\":false}");
